            ...
            <div class="col-6 d-flex flex-row justify-content-end">
                ...
                <div class="">
                    @can('fournisseurs.ajouter-fournisseur')
                        <a href="{{ route('fournisseurs.create') }}" class="btn btn-dark float-end petit_bouton"> <i
                                ...
                                <tbody>
                                    @forelse ($fournisseurs as $fournisseur)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <button class="btn btn-secondary dropdown-toggle btn-small"
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        ...
                                                        {{-- <li>
                                                            <a href="{{route('reglements-frs' , $fournisseur->id)}}" data-bs-toggle="tooltip" class="dropdown-item" data-bs-placement="left" data-bs-title="Voir l'historique du compte">Historique du Compte </a>
                                                        </li> --}}
