...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex">
            <div class="col-6">
                <h1 class="float-left">Rapport des ventes</h1>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-6" style="display: flex; flex-direction: column; justify-content: center; align-items: center">
                            <h3 style="text-decoration: underline"> Montant Vente Comptant </h3>
                            <h1> <span style="color: darkgoldenrod; font-weight: bolder">{{number_format( $total_comptant, 2, ',', ' ')}} <small>FCFA</small></span></h1>
                        </div>

                        <div class="col-6" style="display: flex; flex-direction: column; justify-content: center; align-items: center">
                            <h3 style="text-decoration: underline"> Montant Vente Proforma</h3>
                        ...
                        <div class="col-12" style="display: flex; flex-direction: column; justify-content: center; align-items: center">
                            <h3 style="text-decoration: underline"> Montant Total</h3>
                            <h1><span style="color: darkgoldenrod; font-weight: bolder">{{number_format($total_proforma + $total_comptant, 2, ',', ' ') }} <small>FCFA</small></span></h1>
                        </div>
