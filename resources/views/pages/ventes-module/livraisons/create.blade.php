...
@section('content')
    ...
    <script>
                    ...
                    if (data.articles.length > 0) {
                        ...
                        const firstRow = `
                                <tr>
                                    ...
                                    <td data-name="qte_cmd" contenteditable="true">
                                        <input type="number" step="0.01" name="qte_cdes[]" max="${data.articles[0].qte_cmde}" value="${data.articles[0].qte_cmde}" class="form-control">
                                        <input type="hidden" name="prixUnits[]" readonly value="${data.articles[0].prix_unit}" class="form-control">
                                        </td>
                                    <td data-name="unite" contenteditable="false">${data.articles[0].unite}
                                        <input type="hidden" name="unites[]" readonly value="${data.articles[0].unite_mesure_id}" class="form-control">
                                    </td>
                        ...
                        <tr>
                            ...
                            <td data-name="qte_cmde" contenteditable="true">
                                <input type="number" name="qte_cdes[]" step="0.01" max="${data.articles[i].qte_cmde}" value="${data.articles[i].qte_cmde}" class="form-control">
                                <input type="hidden" name="prixUnits[]" readonly value="${data.articles[0].prix_unit}" class="form-control">
                            </td>
        ...
        $('#client_id').change(function() {
            ...
            $.ajax({
                url: `${apiUrl}/devis_client/${client_id}`,
                type: 'GET',
                success: function(data) {
