...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex">
            <div class="col-6">
                <h1 class="float-left">Retour de stock</h1>
            </div>
    ...
    @endcan -->
                <div class="">
                    <a href="{{ route('back_stock.create') }}" class="btn btn-primary float-end"> + Ajouter</a>
                </div>
            </div>
        </div>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Liste des retours de stock</h5>
                                                                ...
                                                                @can('ventes.voir-vente')
                                                                    <li>
                                                                        <a href="{{ route('back-validation', $back->id) }}"
                                                                            ...
                                                                            data-bs-title="Valider le retour de stock">Validation </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="{{ route('back_stock.edit', $back->id) }}"
                                                                            data-bs-toggle="tooltip" class="dropdown-item"
                                                                            data-bs-placement="left"
                                                                            data-bs-title="Modifier retour de stock">Modifier </a>
                                                                    </li>
                                                                    <li>
                                                                        <form action="{{ route('back_stock.destroy', $back->id) }}"
                                                                            ...
                                                                            <button type="submit" class="dropdown-item"
                                                                                ...
                                                                                data-bs-title="Supprimer la vente">Supprimer</button>
                                                                        </form>
                                                                    </li>
                                                                @endcan
                                                            @endif
