                            ...
                            @if (count($bons) > 0)
                                ...
                                <form class="row g-3" action="{{ route('bons-ventes.store') }}" method="POST">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-control" name="chauffeur_id" id="chauf_select" required>
                        ...
                        const firstRow = `
                                    <tr>
                                        ...
                                        <td data-name="prix_unit" contenteditable="true">
                                            <input type="number"  name="qte_livre[]" max="${data.articles[0].qte_livre}" min="0" step="0.01" class="form-control">
                                            </td>
                        ...
                        for (let i = 1; i < data.articles.length; i++) {
                            const newRow = `
                                        <tr>
                                            ...
                                            <td data-name="prix_unit" contenteditable="true">
                                                <input type="number" name="qte_livre[]" max="${data.articles[i].qte_livre}" min="0" step="0.01" class="form-control">
                                            </td>
